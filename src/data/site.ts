...
export const reviews: Review[] = [
  {
    name: '조○○ 실장',
    role: '경력 3년 1개월 · 강동 ○○피부과 근무',
    field: 'DERMATOLOGY',
    headline: '늘 넘기 어려웠던 일매출 2천만 원을 처음 넘겼습니다.',
    body: '매출이 안 나오는 편은 아니었지만 일매출 1,600~1,700만 원 정도가 되면 항상 그 구간에서 멈췄어요. 저에게 2천만 원은 한번 넘어보고 싶은 벽처럼 느껴졌습니다. 교육을 받으며 가장 크게 달라진 건 고객의 니즈를 어디까지 끌어내고 어떤 순서로 제안해야 하는지를 알게 된 거예요. 제 상담 녹음파일을 들으며 놓치던 부분과 반복되는 말습관을 하나씩 짚어주셨습니다. 한꺼번에 다 바꾸기보다 “오늘 배운 것 중 하나라도 제대로 적용해보자”는 생각으로 상담했는데, 늘 막혀 있던 2천만 원을 처음 넘겼고 최고 2,200만 원까지 찍었습니다. 이제는 왜 매출이 나왔는지 제가 알 것 같아요.',
    result: '일매출 2,200만 원',
  },
  {
    name: '김○○ 실장',
    role: '경력 2년 5개월 · 압구정 ○○성형외과 근무',
    field: 'PLASTIC SURGERY',
    headline: '상담은 많이 하는데, 왜 계약으로 이어지지 않는지 몰랐어요.',
    body: '상담은 정말 열심히 하는데 계약으로 이어지지 않는 고객이 많았어요. 분위기도 좋았고 관심 있어 보였는데 마지막에 “생각해볼게요” 하고 나가시는 분들을 보면 뭐가 문제인지 모르겠더라고요. 녹음파일 피드백을 받으면서 처음 알았습니다. 저는 설명을 많이 해주는 게 상담을 잘하는 거라고 생각했는데, 오히려 제가 너무 많이 말하고 있었고 고객이 왜 망설이는지를 충분히 끌어내지 못하고 있었어요. 질문 방식과 설명 순서, 가격 제시 타이밍, 클로징까지 하나씩 바꾸니 계약률도 올라갔고 그냥 나가시는 고객도 확실히 줄었습니다.',
    result: '계약률 상승',
  },
  {
    name: '이○○ 실장',
  ...
  {
    name: '성○○ 실장',
    role: '경력 2년 4개월 · 인천 ○○피부과 근무',
    field: 'DERMATOLOGY',
    headline: '객단가를 올리라고 하는데, 도대체 어떻게 해야 하는지 몰랐어요.',
    body: '원장님께서 객단가를 조금 더 높였으면 좋겠다고 하시는데 저도 방법을 모르겠더라고요. 총괄실장님께 여쭤봐도 “니즈를 더 끌어내봐라”, “적극적으로 권해봐라” 정도라 막상 상담에 들어가면 그래서 뭘 어떻게 해야 하지 싶었어요. 1회 코칭에서 제 실제 상담 녹음파일을 피드백해주시면서 어디에서 니즈를 놓치는지, 어떻게 자연스럽게 추가 니즈로 연결하는지를 구체적으로 알려주셔서 바로 8회 코칭을 시작했습니다. 지금 5회차까지 진행했는데 객단가가 올라가고 계약률도 함께 좋아졌어요. 이것저것 더 권하는 게 아니라, 고객이 원하는 결과를 이해하고 그에 맞는 솔루션을 제안하는 게 중요하다는 걸 알게 됐습니다.',
    result: '객단가 · 계약률 상승',
  },
  {
    name: '이○○ 실장',
